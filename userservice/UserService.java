...
public class UserService {
    ...
    public static void main(String[] args) {
        ...
        try {
            userService.registerUser("asifa_pathan");
            userService.registerUser("pathan_asifa");

            userService.checkUserExistence("asifa_pathan");
            userService.checkUserExistence("pathn_asifa");
